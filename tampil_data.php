        ...
        <div class="max-w-7xl px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
            ...
            <div class=" grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 lg:gap-12">
                ...
                <a class="group block" href="#">
                    <div class="aspect-w-3 aspect-h-4 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                        <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                            src="https://res.cloudinary.com/dpv5uxesk/image/upload/v1725010366/egdjhbynwwtftdkijsbv.png"
                ...
                <a class="group block" href="#">
                    <div class="aspect-w-3 aspect-h-4 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                        <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                            src="https://res.cloudinary.com/dpv5uxesk/image/upload/v1725010650/gqilpednwa1jh48vnkfd.png"
                            alt="Image Description">
                    </div>
                ...
                <a class="group block" href="#">
                    <div class="aspect-w-3 aspect-h-4 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                        <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl"
                            src="https://res.cloudinary.com/dpv5uxesk/image/upload/v1725010703/viqv3hcpjn6snlrsan9e.png"
                            alt="Image Description">
                    </div>
    ...
    <div
        ...
        <div class="flex items-center gap-px">
            <p
                ...
                Punya haza buat tugas php pokoknya
            </p>
            ...
            <div
                ...
                <!-- Dropdown -->
                <div
                    class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-48 transition-[opacity,margin] duration  hidden z-10 border border-neutral-800 bg-neutral-900 rounded-lg shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:bg-neutral-800 dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)]">
                    <div class="p-1 space-y-0.5">
                        ...
                        <a class="group flex items-center gap-x-1.5 py-1.5 px-2 rounded-md text-[13px] text-gray-200 hover:bg-neutral-800 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 "
                            href="../../index.html">
                            Github
                            <svg class="flex-shrink-0 size-3.5 ms-auto  -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition"
